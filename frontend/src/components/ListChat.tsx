...
const people = [
  ...
  export default function ListChat() {
    return (
        ...
        <div className="flex flex-row h-full w-full overflow-x-hidden rounded-2xl bg-gray-100 my-3">
            <div className="max-w-7xl mx-auto py-12 px-4 text-center sm:px-4 lg:px-6 lg:py-8">
