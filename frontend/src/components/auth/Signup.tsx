...
export default function Login({ switchLogin }: Props) {
  ...
  <div className="relative flex flex-col text-gray-700 bg-white shadow-md w-96 rounded-xl bg-clip-border">
    <div
      className="relative grid mx-4 mb-4 -mt-6 overflow-hidden text-white shadow-lg h-28 place-items-center rounded-xl bg-gradient-to-tr from-cyan-600 to-cyan-800 bg-clip-border shadow-cyan-600">
