      ...
      <div className="flex flex-col gap-4 p-6">
        ...
        <div className="-ml-2.5">
          <div className="inline-flex items-center">
            <label htmlFor="remember-me" className="relative flex items-center p-3 rounded-full cursor-pointer">
              <input
                type="checkbox"
                id="remember-me"
            ...
            <label className="mt-px font-light text-gray-700 cursor-pointer select-none" htmlFor="remember-me">
              Remember Me
            </label>
          </div>
        </div>
