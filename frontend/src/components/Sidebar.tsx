...
function Sidebar() {
    ...
    const SidebarButtons = [
        { link: "/", title: "Home", icon: "material-symbols:home", state: show },
        { link: "/chat", title: "chat", icon: "material-symbols:chat", state: show },
        {
            link: "doctors",
            title: "doctors",
        ...
        { link: "application", title: "Application", icon: "material-symbols:library-books-outline", state: show }
    ];
